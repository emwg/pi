...
class toneLibrary:
    ...
    def __init__(self):
        cls.toneToIndex = dict([('C2',1), ('Cs2',2), ('D2',3), ('Ds2',4), ('E2', 5), ('F2', 6), ('Fs2', 7), ('G2', 8), ('Gs2',9), ('A2',10), ('As2',11), ('B2',12),
        ...
        cls.indexToTone = dict((v,k) for k,v in cls.toneToIndex.items())
        cls.toneToFreq = dict([('C2',65.41), ('Cs2',69.30), ('D2',73.42), ('Ds2',77.78), ('E2',82.41), ('F2',87.31), ('Fs2',92.5), ('G2',98), ('Gs2',103.83), ('A2',110), ('As2',116.54), ('B2',123.47),
    ...
    @classmethod
    def getToneToIndex(cls, tone):
        return cls.toneToIndex[tone]
        
    
    # Takes an index value and returns the corresponding note name string value
    @classmethod
    def getIndexToTone(cls, index):
        if(index < 1):
            return 'C2'
        elif(index > 72):
            return 'B7'
        return cls.indexToTone[index]
    ...
    @classmethod
    def upSteps(cls, numSteps, startingTone):
        index = cls.toneToIndex[startingTone]
        index += numSteps
    ...
    @classmethod
    def downSteps(cls, numSteps, startingTone):
        index = cls.toneToIndex[startingTone]
        index -= numSteps
        if index <= 72 and index >= 0:
            return cls.indexToTone[index]
    ...
    @classmethod
    def getToneToFreq(cls, tone):
        return cls.toneToFreq[tone]